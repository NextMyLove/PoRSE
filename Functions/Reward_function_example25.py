...
def compute_reward(
    ...
    velocity_temp: float = 0.5   # Reduced scale for velocity reward
    progress_temp: float = 0.5   # Adjusted to reflect actual progress
    ...
    # Progress reward for opening the cabinet door
