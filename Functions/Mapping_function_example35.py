    ...
    def mapping_function(self) -> Tuple[List[torch.Tensor], List[bool], List[str]]:
        ...
        #    - Values range from 0.01 to 0.04, with a mean of 0.01. The variation is minimal, and the values are consistently low.
        #    - This variable does not effectively capture task mapping, as it remains nearly identical throughout training.
        ...
        # 3. Replace cabinet_door_angular_velocity with cabinet_door_angular_displacement, which directly measures the door's movement.
        ...
        cabinet_door_angular_displacement = cabinet_door_pos
