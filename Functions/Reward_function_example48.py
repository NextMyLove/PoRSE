...
def compute_reward(
    ...
    velocity_temp: float = 0.5   # Adjusted to reduce scale of velocity reward
    ...
    distance_reward = torch.exp(-distance / distance_temp) * 5.0  # Increased scale
    ...
    velocity_reward = torch.exp(-velocity_reward / velocity_temp)  # Rescaled to smaller range
