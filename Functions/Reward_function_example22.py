...
def compute_reward(
    ...
    distance_temp: float = 0.05  # Adjusted to make distance reward more sensitive
    velocity_temp: float = 0.1   # Reduced to prevent dominance
    progress_temp: float = 1.0   # For intermediate progress rewards
    time_penalty_temp: float = 0.01  # Penalize longer episodes
